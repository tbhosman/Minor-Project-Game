...
public class proceduralGeneration : MonoBehaviour {
    ...
    void Start() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            switch (prullenbak) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (array[0, 5] == 0) { Instantiate(Prullenbak, new Vector3(transform.position.x - 3.55f, transform.position.y + 0.3f, transform.position.z + 2.75f), Quaternion.Euler(270, 0, 0)); array[0, 5] = 1; }
                    break;
                case 3:
                    if (array[6, 0] == 0) { Instantiate(Prullenbak, new Vector3(transform.position.x + 3.55f, transform.position.y + 0.3f, transform.position.z - 2.75f), Quaternion.Euler(270, 0, 0)); array[6, 0] = 1; }
                    break;
            };
        }
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            switch (whiteboard)
            {
                case 0:
                    ...
                    Instantiate(Whiteboard, new Vector3(transform.position.x + 3.75f, transform.position.y-0.2f, transform.position.z), Quaternion.Euler(0, 0, 0));
                    break;
                case 1:
                    Instantiate(Whiteboard, new Vector3(transform.position.x - 3.75f, transform.position.y - 0.2f, transform.position.z), Quaternion.Euler(0, 180, 0));
                    break;
                case 2:
        ...
        for (int i = 0; i < 5; i++) {
            rij = Random.Range(2, 5);
            kolom = Random.Range(2, 4);
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            if (array[rij, kolom] == 0)
            {
                ...
                if (deskoffsetRij != 0)
                {
                    ...
                    if (rij + 2 * deskoffsetRij != 7) { array[rij + 2 * deskoffsetRij, kolom] = 1; }
                    if (rij - deskoffsetRij != -1) { array[rij - deskoffsetRij, kolom] = 1; }
                }
                if (deskoffsetKolom != 0)
                {
                    ...
                    if (kolom + 2 * deskoffsetKolom != 6) { array[rij, kolom + 2 * deskoffsetKolom] = 1; }
                    if (kolom - deskoffsetKolom != -1) { array[rij, kolom - deskoffsetKolom] = 1; }
                }
