...
function Update () {
	...
	if(directionFaced == Direction.X){
		...
		offset = (plane.transform.position.x - character.transform.position.x) + extra_offset;
	...
	if(directionFaced == Direction.Y){
		...
		offset = (plane.transform.position.y - character.transform.position.y) + extra_offset;
	...
	if(directionFaced == Direction.Z){
		...
		offset = (plane.transform.position.z - character.transform.position.z) + extra_offset;
